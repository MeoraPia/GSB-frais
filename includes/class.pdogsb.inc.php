...
class PdoGsb
{
     ...
     */
    //vérifie si on est connecté à la bdd sinon ça fait un new qui permet d'être connecter à la bdd
     ...
     *
     * @param String $idVisiteur ID du visiteur
     * @param int $unIdFrais     ID frais  
     * @param String $mois       Mois sous la forme aaaamm
     * @param String $date       Date 
     * @param String $libelle    Libellé
     * @param int    $montant    Montant
     *
     * @return null
     */
    public function majFraisHorsForfait($idVisiteur, $unIdFrais, $mois, $date, $libelle, $montant)
    {
            ...
            $requetePrepare->bindParam(':unIdVisiteur', $idVisiteur, PDO::PARAM_STR);
            $requetePrepare->bindParam(':unMois', $mois, PDO::PARAM_STR);
            $requetePrepare->bindParam(':idFrais', $unIdFrais, PDO::PARAM_INT);
            $requetePrepare->execute();
        }
